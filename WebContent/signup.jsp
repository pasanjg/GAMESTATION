		...
		<div class="row justify-content-center">
			<div class="col-md-6">
				<div class="card my-5 p-4 text-center">
					<h3>Register Now!</h3>
					<div class="col my-3">
						<img class="img-responsive" src="images/signup.png" width="100"
					...
					<div class="card-body">
						<form method="POST" action="register" method="post"
							onsubmit="return checkPassword();" autocomplete="off">
							<div class="form-group">
								<input type="text" class="form-control" name="firstName"
									id="colFormLabel" placeholder="First Name" required>
							</div>
							<div class="form-group">
								<input type="text" class="form-control" name="lastName"
									id="colFormLabel" placeholder="Last Name" required>
							</div>
							<div class="form-group">
								<input type="email" class="form-control" name="email"
									id="colFormLabel" placeholder="Email" required>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<select class="custom-select" name="country"
									placeholder="Select your country" required>
							...
							<div class="form-group">
								<input type="text" class="form-control" name="userName"
									id="colFormLabel" placeholder="username" required>
							</div>
							<div class="form-group">
								<input type="password" class="form-control" name="password1"
									onKeyUp="checkPassword()" id="pass1" placeholder="Password"
									required>
							</div>
							<div class="form-group">
								<input type="password" class="form-control" name="password2"
									onKeyUp="checkPassword()" id="pass2"
							...
							<button class="btn btn-gs-red px-4" type="reset" name="login"
								value="Login">Reset</button>
							<button class="btn btn-gs-red px-4" type="submit" name="login"
								value="Login">Submit</button>
							<br /> <br /> <span>Already a member? <a href="login"
								style="color: red;">Log in</a></span>
						</form>
					</div>
				</div>
			</div>
