...
<body>
	...
	<nav
		class="navbar navbar-expand-lg navbar fixed-top navbar-dark bg-black"
		style="background-color: black;">
		<div class="container">
			<a class="navbar-brand" href="index.jsp"> <img
				src="images/GameStation.png" height="45" />
			</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<form class="form-inline mx-3 my-lg-0" method="GET" action="search"
					onSubmit="return checkSearch();">
					<input id="navSearchBar" name="q" class="form-control mr-sm-2"
				...
				<ul class="nav justify-content-end">
					<li class="nav-item"><a href="login"><button
								class="btn btn-gs-red mr-2">Login</button></a> <a href="register"><button
								class="btn btn-gs-red">Signup</button></a></li>
				</ul>
